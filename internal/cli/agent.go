...
func generateSkillContent() string {
	return strings.Join([]string{
		...
		"2. Consider global configuration created with `adomi config init --global`.",
		"3. Use repository names, remote URLs, and folder path structure as hints for the Azure DevOps organization, project, or profile.",
		"4. If multiple profiles or projects remain plausible, ask the user to choose.",
		"",
		...
		"3. Run the appropriate `adomi ado fetch` or `adomi ado pr` command.",
