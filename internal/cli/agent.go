...
func generateSkillContent() string {
	return strings.Join([]string{
		...
		"",
		"Never print, log, echo, commit, or otherwise expose PAT values or other secrets. Work item comments require Azure DevOps credentials with work item write permission. PR review-thread maintenance requires appropriate PR/thread write permissions. Linking work items to a PR requires code read and work item write permissions.",
		"",
		"## Output Contract",
		"",
		...
		"",
		"Use conservative PR maintenance commands only when the user asks you to create/update your branch PR, link explicit work items, or maintain explicit review threads:",
		...
		"Safety boundary: PR linking supports only explicit work-item-to-PR linking. It does not provide generic relation editing, unlink/list operations, or work item field/state mutation. Do not use `adomi` to approve, reject, merge, complete, abandon, set auto-complete, bypass policies, or manage reviewers; those PR governance actions are out of scope.",
		"",
		"## Process",
		"",
